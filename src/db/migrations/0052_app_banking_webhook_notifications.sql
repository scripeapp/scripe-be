-- Widens banking webhook reconciliation functions so they return contact
-- and account details (email, director/account names, account numbers),
-- allowing provider-events to dispatch transactional notification emails.
