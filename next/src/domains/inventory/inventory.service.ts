...
export class InventoryService {
  ...
  postMovement(o: InventoryOperation, input: MovementInput): Promise<StockMovement> { return this.run(o, async (c) => { await this.require(c, o.businessId, "inventory.manage"); const row = await repo.postMovement(c, o.businessId, o.userId, input, o.requestId); if (!row) throw new Error("Movement idempotency key already used"); return row; }); }
